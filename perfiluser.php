...
if(isset($_SESSION['user'])){
  ...
  if (isset($_GET['username'])){ 
    //recopilamos la informacion del usuario para que se muestre el perfil del usuario especifico... ya no cogemos la session user :D
 ...
 <?php
    ...
    <div class="row mt-5">
      <div class="col-12 p-3 m-2" style="background-color: white;">
        <h4>Numero de canciones: <?php echo $result2; ?><br></h4>
